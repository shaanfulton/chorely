...
return (
  <ThemedView style={styles.container}>
    {/* header section - shows the chore that was disputed */}
    <View style={styles.header}>
      <View style={styles.iconContainer}>
        <IconComponent size={24} color="#687076" />
      </View>
    ...
    {/* photo evidence section - shows the photo taken when dispute was created */}
    {dispute.imageUrl && (
    ...
    {/* action buttons section - allows admins to approve or reject the dispute */}
