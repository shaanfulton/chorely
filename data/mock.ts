...
const RECENT_ACTIVITIES: RecentActivity[] = [
  {
    ...
    choreDescription: "Clean the bathroom thoroughly",
    choreIcon: "droplets",
  ...
  },
  {
    ...
    choreDescription: "Buy groceries for the week",
  ...
  },
  {
    uuid: uuidv4(),
    choreId: "activity-4",
    choreName: "Trash Takeout",
    choreDescription: "Take out all trash and recycling",
    choreIcon: "trash-2",
  ...
  },
  {
    uuid: uuidv4(),
    choreId: "activity-5",
    choreName: "Plant Watering",
    choreDescription: "Water all indoor plants",
    choreIcon: "leaf",
    userEmail: "sarah@example.com",
    userName: "Sarah",
    completedAt: "2024-01-11T10:20:00Z",
    canDispute: true,
  },
];
